...
const query = `https://min-api.cryptocompare.com/data/v2/histoday?fsym=${coinName}&tsym=USD&limit=30&api_key=4366c332575880687a565e7718298065b467e8e16dd9f56d5b39850fb18eb2fb`
...
const requestURL = `https://newsapi.org/v2/everything?q=${coinName}ANDcrypto&apiKey=Your API key is: 2cf0d6ef88644bb3bafb8364ae465223

&from=${since.format('YYYY-MM-DD')}&to=${moment().format('YYYY-MM-DD')}&language=en&sortBy=relevancy`;
